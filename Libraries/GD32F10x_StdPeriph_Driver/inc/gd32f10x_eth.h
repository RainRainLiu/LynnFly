...
/** 
  * @brief  DMA Tx descriptor RDES0 register Bit def
  */ 
...
/** 
  * @brief  DMA Tx descriptor RDES1 register Bit def
  */ 
...
/** 
  * @brief  DMA Tx descriptor RDES2 register Bit def  
  */ 
#define ETH_DMARXDESC_RB1AP                             ((uint32_t)0xFFFFFFFF)  /*!< Buffer1 Address Pointer */

/** 
  * @brief  DMA Tx descriptor RDES3 register Bit def  
  */ 
