...
#define ADC_EXTERNAL_TRIGGER_MODE_T3_TRIG               ((uint32_t)0x00080000) /*!< Only used in ADC1 and ADC2 */
...
#define ADC_EXTERNALTRIGCONV_T3_CC1                     ((uint32_t)0x00000000) /*!< Only used in ADC3 */
#define ADC_EXTERNALTRIGCONV_T2_CC3                     ((uint32_t)0x00020000) /*!< Only used in ADC3 */
#define ADC_EXTERNALTRIGCONV_T8_CC1                     ((uint32_t)0x00060000) /*!< Only used in ADC3 */
#define ADC_EXTERNALTRIGCONV_T8_TRIG                    ((uint32_t)0x00080000) /*!< Only used in ADC3 */
#define ADC_EXTERNALTRIGCONV_T5_CC1                     ((uint32_t)0x000A0000) /*!< Only used in ADC3 */
#define ADC_EXTERNALTRIGCONV_T5_CC3                     ((uint32_t)0x000C0000) /*!< Only used in ADC3 */
...
/** @defgroup ADC_external_trigger_sources_for_inserted_channels_conversion 
  * @{
  */
#define ADC_EXTERNAL_TRIG_INSERTCONV_T2_TRIG            ((uint32_t)0x00002000) /*!< Only used in ADC1 and ADC2 */ 
...
#define ADC_EXTERNAL_TRIG_INSERTCONV_T4_TRIG            ((uint32_t)0x00005000) /*!< Only used in ADC1 and ADC2 */ 
#define ADC_EXTERNAL_TRIG_INSERTCONV_EXT_IT15_T8_CC4    ((uint32_t)0x00006000) /*!< Only used in ADC1 and ADC2 */ 

#define ADC_EXTERNAL_TRIG_INSERTCONV_T1_TRGO            ((uint32_t)0x00000000) /*!< Used in ADC1,ADC2 and ADC3 */
...
#define ADC_EXTERNALTRIGINSERTCONV_T4_CC3               ((uint32_t)0x00002000) /*!< Only used in ADC3 */
#define ADC_EXTERNALTRIGINSERTCONV_T8_CC2               ((uint32_t)0x00003000) /*!< Only used in ADC3 */
#define ADC_EXTERNALTRIGINSERTCONV_T8_CC4               ((uint32_t)0x00004000) /*!< Only used in ADC3 */
#define ADC_EXTERNALTRIGINSERTCONV_T5_TRIG              ((uint32_t)0x00005000) /*!< Only used in ADC3 */
#define ADC_EXTERNALTRIGINSERTCONV_T5_CC4               ((uint32_t)0x00006000) /*!< Only used in ADC3 */
