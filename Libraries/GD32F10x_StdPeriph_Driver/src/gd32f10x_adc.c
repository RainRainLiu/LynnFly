...
/**
  ...
  *   This parameter can be as follows:
  *     @arg ADC_EXTERNAL_TRIG_INSERTCONV_T1_TRIG: Timer1 TRIG event (used in ADC1, ADC2 and ADC3) 
  *     @arg ADC_EXTERNAL_TRIG_INSERTCONV_T1_CC4: Timer1 capture compare4 (used in ADC1, ADC2 and ADC3) 
  *     @arg ADC_EXTERNAL_TRIG_INSERTCONV_T2_TRIG: Timer2 TRIG event (used in ADC1 and ADC2)
  ...
  *     @arg ADC_EXTERNAL_TRIG_INSERTCONV_T4_TRIG: Timer4 TRIG event (used in ADC1 and ADC2)
  ...
  *     @arg ADC_EXTERNALTRIGINSERTCONV_T4_CC3: Timer4 capture compare3 (used in ADC3)
  *     @arg ADC_EXTERNALTRIGINSERTCONV_T8_CC2: Timer8 capture compare2 (used in ADC3)                         
  *     @arg ADC_EXTERNALTRIGINSERTCONV_T8_CC4: Timer8 capture compare4 (used in ADC3)
  *     @arg ADC_EXTERNALTRIGINSERTCONV_T5_TRIG: Timer5 TRIG event (used in ADC3)                         
  *     @arg ADC_EXTERNALTRIGINSERTCONV_T5_CC4: Timer5 capture compare4 (used in ADC3)                      
  *     @arg ADC_EXTERNALTRIGINSERTCONV_NONE: Inserted conversion started by software (used in ADC1, ADC2 and ADC3) 
  * @retval None
  */
...
/**
  ...
  *   This parameter can be as follows:
  *     @arg ADC_FLAG_AWD: The flag of the analog watchdog
  *     @arg ADC_FLAG_EOC: The flag of the end of conversion
  *     @arg ADC_FLAG_IEOC: The flag of the end of inserted group conversion
  *     @arg ADC_FLAG_ISTRT: The flag of the start of inserted group conversion
  *     @arg ADC_FLAG_STRT: The flag of the start of regular group conversion
...
/**
  ...
  *     @arg ADC_INT_AWD: The interrupt mask of the analog watchdog
  *     @arg ADC_INT_IEOC: The interrupt mask of the end of inserted conversion
