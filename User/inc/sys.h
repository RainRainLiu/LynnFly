...
#define USB_CONTROL_IO_A        GPIO_PIN_10

#define PERPHE_POWER_CTRL_IO_B  GPIO_PIN_12
#define ALARM_INT_IO_B          GPIO_PIN_12

#define ALARM_INT_IN            PBin(12)

#define USB_TE                  PAout(10)

#define USB_IN                  PAin(8)
